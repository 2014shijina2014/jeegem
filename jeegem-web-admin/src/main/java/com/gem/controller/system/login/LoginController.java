package com.gem.controller.system.login;
...
import com.gem.common.utils.IPUtil;
...
import com.gem.service.system.log.LoginLogService;
...
public class LoginController extends BaseController<Object>{
	...
	public Map<String, Object> login()throws Exception{
		...
		String errInfo = "";
		String KEYDATA[] = pd.getString("KEYDATA").split(",gem,");
