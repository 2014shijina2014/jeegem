    ...
    <div class="tab-content noline tabCenter">
		...
		<div id="proSetting" class="tab-pane">
			  <table  class="customTable">
			  	...
			  	<!-- <tr class="FormData">
					<td>
					<input id="gem-settings-navbar" name="fixNavbar" class="ace ace-checkbox-2" type="checkbox"> 
					<label class="lbl" for="gem-settings-navbar"> 固定导航条 <b></b></label>
					</td>
			  	</tr> -->
			  	<!-- <tr class="FormData">
					<td>
					<input id="gem-settings-fixMenu" name="fixMenu" class="ace ace-checkbox-2" type="checkbox"> 
					<label class="lbl" for="gem-settings-fixMenu"> 固定菜单栏 <b></b></label>
					</td>
			  	</tr> -->
			  	<tr class="FormData">
					<td>
					<input id="gem-settings-add-container" name="narWinMenu" class="ace ace-checkbox-2" type="checkbox"> 
					<label class="lbl" for="gem-settings-add-container"> 切换窄屏幕 <b></b></label>
					</td>
			  	</tr>
			  	<tr class="FormData">
					<td>
					<input id="gem-settings-sfMenu" name="sfMenu" class="ace ace-checkbox-2" type="checkbox"> 
					<label class="lbl" for="gem-settings-sfMenu"> 缩放菜单栏 <b></b></label>
					</td>
			  	</tr>			  	
			  	<tr class="FormData">
					<td>
				  		<input id="gem-settings-rtl" name="posMenu" class="ace ace-checkbox-2" type="checkbox">
			...
			<form id="perfileSettingFrom" method="POST" onsubmit="return false;">
				<div class="profile-user-info profile-user-info-striped">
					...
					<div class="profile-info-row">
						...
						<div class="profile-info-value tab-pane-right">
							<div class="clearfix">
								<input type="text" gemValidate="email" id='perDataEmail' maxlength="120" name='email' class="col-xs-12">
							</div>
						</div>
					</div>
					<div class="profile-info-row">
