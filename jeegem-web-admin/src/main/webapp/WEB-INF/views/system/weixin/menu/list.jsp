...
<link rel="stylesheet" href="${gempath}/static/css/system/system/weixin.css" />
</head>
<body>
					...
					<div>
						<form id="menuForm" class="form-horizontal" >
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" gemValidate="required" name="name" maxlength="20" class="col-xs-10 col-sm-5"   >
								</div>
							</div>
							<div class="form-group">
...
<script src="${gempath}/static/js/system/weixin/menu/menu.js"></script>
</body>
</html>