...
<link rel="stylesheet" href="${gempath}/static/plugins/webuploader/css/webuploader.css" />
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        auto: true,
        // swf文件路径
        swf: gempath + '/static/plugins/webuploader/js/Uploader.swf',
        // 文件接收服务端。
        server: gempath +'/backstage/tool/webuploader/uploadFile',
        // 选择文件的按钮。可选。
 ...
 // 文件上传过程中创建进度条实时显示。
    ...
    uploader.on( 'uploadSuccess', function(file,json) {
        ...
        if("1"==json.res){
        	...
        	if(GEM.Object.notNull(savePath)){
        		savePath+=","+json.saveUrl;
        	}else{
        		savePath=json.saveUrl;
        		GEM.Model.info(json.resMsg);
        	}
        	$("#savePath").val(savePath);
        	
        }else{
        	GEM.Model.error(json.resMsg);
