...
<link rel="stylesheet" href="${gempath}/static/plugins/zTree/3.5/zTreeStyle.css" />
<script type="text/javascript" src="${gempath}/static/plugins/zTree/3.5/jquery.ztree.core-3.5.min.js"></script>
<script type="text/javascript" src="${gempath}/static/plugins/zTree/3.5/jquery.ztree.excheck-3.5.js"></script>
</head>
<body>
...
<script src="${gempath}/static/js/system/org/position.js"></script>
</body>
</html>