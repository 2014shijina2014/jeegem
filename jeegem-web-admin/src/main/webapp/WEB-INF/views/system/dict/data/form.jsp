			...
			<table cellspacing="0" cellpadding="0" border="0" class="customTable">
				<tbody>
					...
					<tr class="FormData">
						...
						<td class="DataTD">&nbsp;
						<input type="text" maxlength="16" gemValidate="required,ennum" name="dataKey" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
	...
	<table cellspacing="0" cellpadding="0" border="0" class="customTable">
		<tbody>
			<tr class="FormData">
				...
				<td class="DataTD">&nbsp;
				<input type="text" maxlength="16" gemValidate="required,ennum" name="value" class="FormElement ui-widget-content ui-corner-all"></td>
			</tr>
			<tr class="FormData">
				<td class="CaptionTD"><font color="red">*</font>中文说明：</td>
				<td class="DataTD">&nbsp;
				<input type="text" maxlength="32" gemValidate="required" name="name" class="FormElement ui-widget-content ui-corner-all"></td>
			</tr>
			<tr class="FormData">
				<td class="CaptionTD"><font color="red">*</font>顺序：</td>
				<td class="DataTD">&nbsp;
				<input type="number" value="1" gemValidate="required,numrangeth" name="sort" min='1' max='99999' gemValidate="required,numrangeth" onkeyup='this.value=this.value.replace(/\D/g,&apos;&apos;)'  class="FormElement ui-widget-content ui-corner-all isSelect75"></td>
			</tr>		
		</tbody>
	</table>
</div>
