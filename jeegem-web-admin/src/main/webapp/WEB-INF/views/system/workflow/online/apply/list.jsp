...
<body>
			...
			<div class="col-xs-12">
				<form id='leaveFrom' class="form-horizontal" method="POST" onsubmit="return false;">
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" name="org" gemValidate="required"  maxlength="32" class="col-xs-12 col-sm-12" >
						</div>	
						<label class="col-sm-1 control-label no-padding-right"><font color="red">*</font>申请人</label>
						<div class="col-sm-2">
							<input type="text" name="name" gemValidate="required" maxlength="16" class="col-xs-12 col-sm-12" >
						</div>	
						<label class="col-sm-1 control-label no-padding-right"><font color="red">*</font>审批人</label>
						<div class="col-sm-2">
							<input type="text" name="approver" gemValidate="required"  maxlength="16" class="col-xs-12 col-sm-12"  >
						</div>	
					</div>
					...
					<label class="col-sm-2 control-label no-padding-right"><font color="red">*</font>请假类型</label>
						...
						<div class="col-sm-1">
								<input name="beginTime" value="" gemValidate="required,datetime" class="date-picker" type="text" placeholder="请假开始时间" >					
						</div>
						<label class="col-sm-2 control-label no-padding-right"><font color="red">*</font>结束时间</label>
						<div class="col-sm-1">
							<input name="endTime" value="" gemValidate="required,datetime" class="date-picker" type="text" placeholder="请假结束时间" >	
						</div>	
					</div>				
					<div class="space-4"></div>
					<div class="form-group">
	...
	<script src="${gempath}/static/js/system/workflow/online/apply.js"></script>		
</body>
</html>