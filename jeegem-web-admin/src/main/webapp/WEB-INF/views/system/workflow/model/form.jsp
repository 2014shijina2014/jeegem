...
<div id="auDiv" class="hide">
		<form id="auForm" target="_blank" method="POST" action="${gempath}/backstage/workflow/model/create" >
			<table cellspacing="0" cellpadding="0" border="0" class="customTable">
				<tbody>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>名称：</td>
						<td class="DataTD">&nbsp;
						<input type="text" gemValidate="required" role="textbox" maxlength="64" name="name" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>KEY：</td>
						<td class="DataTD">&nbsp;
						<input type="text" gemValidate="required,ennum" role="textbox" maxlength="32" name="key" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
