			...
			<table cellspacing="0" cellpadding="0" border="0" class="customTable">
				<tbody>
					...
					<tr class="FormData">
						...
						<td class="DataTD">&nbsp;
						<input type="text" gemValidate="required"  maxlength="16" name="loginName" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>
					<tr class="FormData">
						<td class="CaptionTD"><font color="red">*</font>用户角色：</td>
						<td class="DataTD">&nbsp;
							<input id="roleName" gemValidate="required" type="text" readonly value="" class="FormElement ui-widget-content ui-corner-all" onclick="showRole(); return false;"/>
					...
					<tr class="FormData">
						...
						<td class="DataTD">&nbsp;
						<input type="text" gemValidate="email"  maxlength="32" name="email" class="FormElement ui-widget-content ui-corner-all"></td>
					</tr>	
					<tr class="FormData">
		...
		<table cellspacing="0" cellpadding="0" border="0" class="customTable">
			<tbody>
				...
				<tr class="FormData">
					...
					<td class="DataTD">&nbsp;
						<input type="password" gemValidate="required"  maxlength="16" name="pwd" class="FormElement ui-widget-content ui-corner-all">
					</td>
				</tr> 
			</tbody>
		</table>
