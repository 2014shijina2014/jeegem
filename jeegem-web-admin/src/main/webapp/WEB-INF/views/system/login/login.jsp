...
<link rel="stylesheet" href="${gempath}/static/css/system/ace/camera.css" />
<link rel="stylesheet" href="${gempath}/static/css/system/system/login.css" />
...
<script src="${gempath}/static/js/system/login/login.js"></script>
</head>
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1><i class="icon-apple green"></i> <span class="red">GEM</span>&nbsp;<span class="white">System</span></h1>
