$(function () {
              JEEGEM.Dict.setSelect("selectLeaveType","leaveType","1");
...
function submitApply(){
	if(JEEGEM.Validate.form("leaveFrom")){
		var type=$("#leaveFrom select[name='type']").val();
		if(JEEGEM.Object.notNull(type)){
		              JEEGEM.Model.confirm("确认提交申请吗?",function(){	
			              JEEGEM.Ajax.doRequest("leaveFrom",jeegempath +'/backstage/workflow/online/apply/start',"",function(data){
